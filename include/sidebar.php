<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="view_project.php">
                            <i class="bi bi-circle"></i><span>View All Project</span>
                        </a>
                    </li>
                    <!-- <li>
        ...
        ?>
            <li class="nav-item">
                <a class="nav-link collapsed" href="./mentor_projets.php">
        ...
        <!-- <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-layout-text-window-reverse"></i><span>Find Mentor</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
