                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <center>
                                                ...
                                                <div class="p-1">
                                                    <a href="./add_new_project.php?p=<?php echo $row['prj_id']; ?>"><button type="button" class="btn btn-warning col-4">Edit</button></a>
                                                    <button type="submit" name="project_delete" class="btn btn-danger col-6">Delete</button>
                                                </div>
                                            </center>
                                        </div>
                                    </div>
